import { getAllCategories, getCategoryByID, deleteCategoryByID,postCategory,editCategoryByID } from "./httprequests.js";
let list = document.querySelector("#categories")
let detail = document.querySelector("#detail")
//use categories
getAllCategories().then(data=>{//promise
...
//use edit category
editCategoryByID(3,{name:'salam',description:'salam1223'})